...
class TestDeviceScheduler:
    ...
    @patch('waterbot.scheduler.DEVICE_SCHEDULES', {
    ...
    @patch('waterbot.scheduler.config_add_schedule')
    ...
    @patch('waterbot.scheduler.config_remove_schedule')
    @patch('waterbot.scheduler.schedule')
    ...
    def test_start_scheduler(self):
        ...
        with patch.object(self.scheduler, 'setup_schedules') as mock_setup:
            with patch('threading.Thread') as mock_thread:
                ...
                assert self.scheduler.running == True
...
class TestSchedulerModuleFunctions:
    ...
    def test_start_stop_scheduler_functions(self):
        ...
        from waterbot.scheduler import start_scheduler, stop_scheduler, get_scheduler
    ...
    def test_add_remove_schedule_functions(self):
        ...
        from waterbot.scheduler import add_schedule, remove_schedule, get_scheduler
