...
from waterbot.gpio.interface import GPIOInterface, HardwareGPIO, EmulationGPIO, MockGPIO
...
class TestEmulationGPIO:
    ...
    def test_setup_pin(self):
        ...
        assert gpio.pin_states[17] == False
    ...
    def test_output_pin_value(self):
        ...
        gpio.output(17, True)
        assert gpio.get_pin_state(17) == True
        
        gpio.output(17, False)
        assert gpio.get_pin_state(17) == False
...
class TestMockGPIO:
    ...
    def test_cleanup_tracking(self):
        ...
        assert gpio.cleanup_called == True
        assert len(gpio.pin_states) == 0
