...
class TestWaterBot:
    ...
    def test_send_message_to_recipient(self, mock_run):
        ...
        success = self.bot._send_message(recipient="+1234567890", message="test message")
    ...
    def test_execute_command_device_on(self):
        ...
        with patch('waterbot.signal.bot.gpio_handler.turn_on') as mock_turn_on:
            ...
            response = self.bot._execute_command("device_on", {"device": "pump", "timeout": None})
    ...
    def test_execute_command_device_on_with_timeout(self):
        ...
        with patch('waterbot.signal.bot.gpio_handler.turn_on') as mock_turn_on:
            ...
            response = self.bot._execute_command("device_on", {"device": "pump", "timeout": 3600})
    ...
    def test_execute_command_device_off(self):
        ...
        with patch('waterbot.signal.bot.gpio_handler.turn_off') as mock_turn_off:
            ...
            response = self.bot._execute_command("device_off", {"device": "light", "timeout": None})
    ...
    def test_execute_command_all_off(self):
        ...
        with patch('waterbot.signal.bot.gpio_handler.turn_all_off') as mock_turn_all_off:
    ...
    def test_execute_command_schedule_add(self):
        ...
        with patch('waterbot.signal.bot.scheduler.add_schedule') as mock_add_schedule:
            ...
            response = self.bot._execute_command("schedule_add", {
                "device": "pump", 
                "action": "on", 
                "time": "08:00"
            })
    ...
    def test_execute_command_schedule_remove(self):
        ...
        with patch('waterbot.signal.bot.scheduler.remove_schedule') as mock_remove_schedule:
            mock_remove_schedule.return_value = True
            
            response = self.bot._execute_command("schedule_remove", {
                "device": "pump", 
                "action": "on", 
                "time": "08:00"
            })
    ...
    def test_execute_command_show_schedules(self):
        ...
        mock_next_runs = [
            {'device': 'pump', 'action': 'on', 'time': '08:00', 'next_run': '2024-01-01 08:00:00'}
        ]
        
        with patch('waterbot.signal.bot.get_schedules') as mock_get_schedules:
            with patch('waterbot.signal.bot.scheduler.get_next_runs') as mock_get_next_runs:
    ...
    def test_handle_message_group_message(self):
        ...
        with patch.object(self.bot, '_execute_command') as mock_execute:
            with patch.object(self.bot, '_send_message') as mock_send:
                ...
                mock_send.assert_called_once_with(group_id=self.bot.group_id, message="Test response")
    ...
    def test_handle_message_direct_message(self):
        ...
        with patch.object(self.bot, '_execute_command') as mock_execute:
            with patch.object(self.bot, '_send_message') as mock_send:
                ...
                mock_execute.assert_called_once()
                mock_send.assert_called_once_with(recipient="+1234567890", message="Test response")
