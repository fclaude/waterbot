...
class TestDeviceController:
    ...
    def test_device_setup(self):
        ...
        for device in self.device_config:
            assert self.controller.device_status[device] == False
    ...
    def test_turn_on_device(self):
        ...
        assert success == True
        assert self.controller.device_status['pump'] == True
    ...
    def test_turn_off_device(self):
        ...
        assert success == True
        assert self.controller.device_status['pump'] == False
    ...
    def test_get_status(self):
        ...
        assert status['light'] == True
        assert status['fan'] == False
    ...
    def test_turn_all_on(self):
        ...
        assert success == True
        for device in self.device_config:
            assert self.controller.device_status[device] == True
    ...
    def test_cleanup(self):
        ...
        with patch('waterbot.gpio.handler.Timer') as mock_timer:
            ...
            assert self.mock_gpio.cleanup_called == True
...
class TestDeviceControllerModuleFunctions:
    ...
    def test_module_turn_on(self):
        ...
        from waterbot.gpio.handler import turn_on, set_controller
        from waterbot.gpio.interface import MockGPIO
    ...
    def test_module_get_status(self):
        ...
        from waterbot.gpio.handler import get_status, turn_on, set_controller
        from waterbot.gpio.interface import MockGPIO
